...
class HomeController < ApplicationController
  ...
  def about
    set_page_title("Earn your first dollar online with Gumroad")
  ...
  def features
    set_page_title("Gumroad features: Simple and powerful e-commerce tools")
  ...
  def hackathon
    set_page_title("Gumroad $100K Niche Marketplace Hackathon")
  ...
  def pricing
    set_page_title("Gumroad pricing: 10% flat fee")
  ...
  def privacy
    set_page_title("Gumroad privacy policy: how we protect your data")
  ...
  def prohibited
    set_page_title("Prohibited products on Gumroad")
  ...
  def terms
    set_page_title("Gumroad terms of service")
  ...
  def small_bets
    set_page_title("Small Bets by Gumroad")
