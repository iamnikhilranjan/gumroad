...
class LinksController < ApplicationController
  ...
  def index
    ...
    render inertia: "Products/Index", props: {
      ...
      products_pagination: -> { products_page_presenter.products_table_props[:products_pagination] },
      products_sort: -> { products_page_presenter.products_sort },
      memberships: -> { products_page_presenter.memberships_table_props[:memberships] },
      memberships_pagination: -> { products_page_presenter.memberships_table_props[:memberships_pagination] },
      memberships_sort: -> { products_page_presenter.memberships_sort },
    }
  end
