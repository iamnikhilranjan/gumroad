...
describe AssetPreview, :vcr do
  describe "Attachment" do
    it "scales down a big image and keeps original" do
      ...
      expect(asset_preview.file.url).to match("http://127.0.0.1:9000/gumroad-test-public/#{asset_preview.file.key}")
      expect(asset_preview.retina_variant.url).to match("http://127.0.0.1:9000/gumroad-test-public/#{asset_preview.retina_variant.key}")
    ...
    it "succeeds with video" do
      ...
      expect(asset_preview.url).to match("http://127.0.0.1:9000/gumroad-test-public/#{asset_preview.file.key}")
    end
