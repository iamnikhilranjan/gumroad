...
describe Api::Mobile::PurchasesController do
  ...
  describe "GET index" do
    before do
      ...
      create(:product_file, link_id: @mobile_zip_file_product.id, url: "#{S3_BASE_URL}/specs/test.zip")
    end
    ...
    describe "successful response format" do
      it "returns product and file data" do
        ...
        create(:product_file, link: product, description: "A song", url: "#{S3_BASE_URL}/specs/magic.mp3")
    ...
    describe "show all products" do
      ...
      it "includes preorder products", :vcr do
        ...
        create(:product_file, link_id: product.id, url: "#{S3_BASE_URL}/specs/preorder.zip")
